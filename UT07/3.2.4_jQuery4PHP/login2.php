...
<body style="background:#00bfa5;">
    <?php
    //Cargamos idiomas en castellano descargate del proyecto la carpeta localization
    echo YsJQueryAssets::loadScripts('../vendor/localization/messages_es.js')->execute();
    ?>
